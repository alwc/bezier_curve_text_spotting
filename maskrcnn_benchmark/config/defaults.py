...
_C.MODEL.ONE_STAGE_HEAD = 'yolact'
...
_C.MODEL.PANOPTIC.HEAD = 'UPS'
_C.MODEL.PANOPTIC.PANOPTIC_ON = False
_C.MODEL.PANOPTIC.CHANNEL_SIZE = 128
_C.MODEL.PANOPTIC.NUM_CLASSES = 1
_C.MODEL.PANOPTIC.LAMBDA_S = 1.0
...
# ---------------------------------------------------------------------------- #
_C.MODEL.HNASNET = CN()
_C.MODEL.HNASNET.FILTER_MULTIPLIER = 16
_C.MODEL.HNASNET.NUM_LAYERS = 12
_C.MODEL.HNASNET.NUM_BLOCKS = 5
_C.MODEL.HNASNET.STRIDE_MULTIPLIER = (1, 2, 4, 8)
_C.MODEL.HNASNET.BACKBONE_OUT_CHANNELS = 256
_C.MODEL.HNASNET.AFFINE = True
_C.MODEL.HNASNET.TIE_CELL = False
_C.MODEL.HNASNET.PRIMITIVES = "AutoDeepLab"
_C.MODEL.HNASNET.GENOTYPE = ""
_C.MODEL.HNASNET.BLOCK_CFG = "mn3"
